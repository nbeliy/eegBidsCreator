...
def parce_CLI(argv, VERSION):
    '''Parce passed array of string and returns resulting argparse.ArgumentParser object'''
    ...
    parser.add_argument('--mem', nargs=1, type=int, help='allowed memury usage (in GiB)')
